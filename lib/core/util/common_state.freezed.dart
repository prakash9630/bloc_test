...
mixin _$CommonState<T> {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is CommonState<T>);
  }
...
class Initial<T> implements CommonState<T> {
  const Initial();
...
class Loading<T> implements CommonState<T> {
  const Loading();
...
class Success<T> implements CommonState<T> {
...
class Error<T> implements CommonState<T> {
